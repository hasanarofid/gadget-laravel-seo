...
<x-app-layout>
    <x-slot name="header">
        ...
        <h4>Edit Landing Page( {{ $gallery->title }} )</h4>
    </x-slot>
    <div class="py-12 ">
        @if ($errors->any())
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <table>
                <tr>
                    ...
                    <td>
                        <form class="w-full max-w-sm" method="POST" action="{{ route('landingpage.update',$gallery->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="md:flex md:items-center mb-6">
                                ...
                                <div class="md:w-2/3">
                                    <select class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="artikel_id">
                                        ...
                                        <option value="{{ $artikel->id }}" {{ $gallery->artikel_id == $artikel->id ? 'selected' : '' }}>
                                            {{ $artikel->judul }}
                                        </option>
                                        @endforeach
                                    </select>
