<x-app-layout>
    ...
    <div class="py-12 ">
        ...
        <div class="overflow-x-auto">
            ...
            <div class="overflow-x-auto">
                <a href="{{ route('gambar.create') }}"><button class="btn btn-primary ml-3">Add New</button></a>
                <div class="overflow-x-auto">
                                ...
                                <table class="divide-y divide-gray-300 m-3 w-full">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-300" style="text-align: center;">
                                        ...
                                        <tr class="whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4  ">
                                                <a href="gambar/edit/{{$gallery->id }}"><button class="px-4 py-1  btn btn-primary">Edit</button></a>
                                            </td>
                                            @method('DELETE')
                                            <td class="px-6 py-4  ">
                                                <a href="gambar/destroy/{{$gallery->id }}"><button class="px-4 py-1  btn btn-error">Delete</button></a>
                                            </td>
                                            @endforeach
                                        </tr>
                                    </tbody>
