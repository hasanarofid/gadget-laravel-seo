<x-app-layout>
    <x-slot name="header">
        ...
        <h4>Overview Tipe Manage</h4>
    </x-slot>
    <div class="py-12 ">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('overview.create') }}"><button class="btn btn-primary mb-2">Add New</button></a>
                                ...
                                <tbody class="bg-white divide-y divide-gray-300">
                                  ...
                                  @foreach ($model as $artikel)
                                    ...
                                    <tr class="whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500">
                                            <a href="overview/edit/{{$artikel->id }}">                                           
                                            <button class="btn btn-primary px-4 py-1 text-sm">Edit</button>
                                            </a>
                                        </td>

                                         <td class="px-6 py-4 text-sm text-gray-500">
                                            <a href="overview/destroy/{{$artikel->id }}">                                           
