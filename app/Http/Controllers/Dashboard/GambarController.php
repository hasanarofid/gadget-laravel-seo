...
class GambarController extends Controller
{
    ...
    {
        $gallery = gallery::where('kategori', 'section-gambar')->get();
        return view('dashboard.gambar.index', ['gallery' => $gallery]);
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.gambar.tambah',compact('artikel'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.gambar.edit', compact('gallery','artikel'));
    }
    ...
    public function update(UpdategalleryRequest $request, gallery $gallery)
    {
        ...
        $gallery->kategori = 'section-gambar';
